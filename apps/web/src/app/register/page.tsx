      ...
      <main className="relative z-10 mx-auto flex w-full max-w-6xl flex-col gap-10 px-6 py-16 lg:flex-row lg:gap-16">
        <section className="flex flex-1 flex-col justify-center gap-6">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">
            Create your VoiceAI workspace.
          </h1>
          <p className="max-w-xl text-base text-gray-400">
            Start generating speech, track usage, and manage projects in one
            place.
          </p>
          <div className="rounded-2xl border border-white/10 bg-linear-to-br from-gray-900/50 to-gray-950/50 p-6 text-sm text-gray-300">
            "The API onboarding took minutes and we shipped faster."
          </div>
        </section>
        ...
        <section className="w-full max-w-md rounded-3xl border border-white/10 bg-linear-to-br from-gray-900/70 to-gray-950/70 p-6 shadow-2xl backdrop-blur">
          <div className="mb-6">
            ...
            <p className="text-sm text-gray-400">
              Start with Google or your email.
            </p>
          </div>
